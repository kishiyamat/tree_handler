...
def test_content2columns():
    ...
    tgt = {"p3": "s", "f2": 2, "a1": -1, "L": 1, "a2": 1, "M": "", "B": "xx-xx_xx", "C": "07_xx+xx", "D": "02+xx_xx"}
    assert res == tgt
    ...
    inf2 = inf2.split(" ")[2]
    res = parser.content2columns(inf2)
    tgt = {"p3": "o", "f2": 2, "a1": 0, "L": 1, "a2": 2, "M": "", "B": "xx-xx_xx", "C": "07_xx+xx", "D": "02+xx_xx"}
    assert res == tgt
    ...
    inf2 = inf2.split(" ")[2]
    res = parser.content2columns(inf2)
    tgt = {"p3": "k", "f2": 3, "a1": -2, "L": 3, "a2": 1, "M": "", "B": "07-xx_xx", "C": "02_xx+xx", "D": "13+xx_xx"}
    assert res == tgt
    ...
    inf2 = inf2.split(" ")[2]
    res = parser.content2columns(inf2)
    tgt = {"p3": "sil", "f2": 0, "a1": -100, "L": 200, "a2": 100, "M": "", "B": 0, "C": 0, "D": 0}
    assert res == tgt
    # inf
    parser = InfParser(version=1)
    inf2 = "3100000 4300000 xx^sil-s+o=n/A:-1+1+2/B:xx-xx_xx/C:07_xx+xx/D:02+xx_xx/E:xx_xx!xx_xx-xx/F:2_2#0_xx@1_5|1_21/G:6_3%0_xx_1/H:xx_xx/I:5-21@1+1&1-5|1+11/J:xx_xx/K:1+5-11"
    inf2 = inf2.split(" ")[2]
    res = parser.content2columns(inf2)
    # Lは存在しないので0になる。
